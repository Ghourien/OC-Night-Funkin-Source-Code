		...
		switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
				...
				if(!ClientPrefs.lowQuality) {
					...
					case 'josh_back': //Week 7
					var bg:BGSprite = new BGSprite('josh_sky', -800, -1150, 0.5, 0.5);
					add(bg);
					
					var stageFront:BGSprite = new BGSprite('josh_floor', -800, -1280, 0.9, 0.9);
				stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
				stageFront.updateHitbox();
				add(stageFront);
					
					case 'mAn_bg': //Week 8
					var bg:BGSprite = new BGSprite('mAn_sky', -230, -200, 0.5, 0.5);
					add(bg);
					
					var stageFront:BGSprite = new BGSprite('mAn_floor', -320, -200, 0.9, 0.9);
				stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
				stageFront.updateHitbox();
				add(stageFront);
					
					case 'chasm_bg': //Week 9
					var bg:BGSprite = new BGSprite('Sky', -400, -300, 0.5, 0.5);
					add(bg);
					
					
				var stageFront:BGSprite = new BGSprite('chasmfront', -600, 460, 0.9, 0.9);
				stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
				stageFront.updateHitbox();
				add(stageFront);
